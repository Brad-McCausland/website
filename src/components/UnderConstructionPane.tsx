...
export class UnderConstructionPane extends React.Component<UnderConstructionPaneProps, UnderConstructionPaneState>
{
    ...
    render ()
    {
        var githubLink = <a href={BMStyle.GithubUrl} target="_blank" rel="noopener noreferrer" style = {{color: BMStyle.LightTheme.colors.UIMainColor}}>Github</a>;
        var linkedinLink = <a href={BMStyle.LinkedInUrl} target="_blank" rel="noopener noreferrer" style = {{color: BMStyle.LightTheme.colors.UIMainColor}}>Linkedin</a>;
        return (
                ...
                {({IsMobileWidth}) => (
                    ...
                    >
                        <div
                            ...
                            style = 
                            {{
                                width: IsMobileWidth ? "80vw" : "50vw",
                                height:IsMobileWidth ? "80vh" : "50vh",
                                position: "relative",
